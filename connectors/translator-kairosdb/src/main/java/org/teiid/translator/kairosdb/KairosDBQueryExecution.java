 ...
 */
public class KairosDBQueryExecution implements ResultSetExecution {
     ...
     * 
     */
    public KairosDBQueryExecution(Select query) {
        this.query = query;
    }
    ...
    public void execute() throws TranslatorException {
        // Log our command
        LogManager.logTrace(LogConstants.CTX_CONNECTOR, "kairosdb executing command: " + command); //$NON-NLS-1$
    }    
